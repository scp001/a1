...
app.get('/comments/:movieId', splat.comments);
app.post('/comments', splat.addComment);
app.put('/comments/:id', splat.editComment);
app.delete('/comments/:id', splat.deleteComment);
